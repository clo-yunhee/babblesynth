...
/*!
    ...
    \inmodule QtCharts
    \brief The QColorLineSeries class presents data in line charts.
    ...
    \code
    QColorLineSeries* series = new QColorLineSeries();
    series->append(0, 6);
    series->append(2, 4);
    ...
...
/*
QDebug operator<< (QDebug debug, const QColorLineSeries series)
{
